...
| x86_64 Linux | **No** (deferred, [#40](https://github.com/onexay/msl/issues/40)) | n/a (x86_64 host) | Rosetta | Rosetta | Rosetta (vz) or QEMU | No | QEMU emulation, Rosetta (Apple backend) | Rosetta (`--rosetta`) |
